...
public class AnimalTester {
    public static void main(String[] args) throws InterruptedException {
       /* Animal animal=new Animal(); // instead of this code we will use below (use of polymorphism)
        animal.speak();
        animal.eat();
        Dog dog=new Dog();
        dog.speak();
        ...
        /*ChromeDriver c=new ChromeDriver(); instead of this code we will use below (use of polymorphism)
